...
# Replace lines 255-270 (0-indexed 254:269)
lines[254:270] = [new_json]
...
# Replace lines 369-432 (0-indexed 368:432)
lines[368:432] = [new_up]

with open('C:/agent-workspace/generate_agent_dll.py', 'w', encoding='utf-8', newline='\n') as f:
    f.writelines(lines)

print('generator fixed by line ranges')
